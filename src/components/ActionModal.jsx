...
const ActionModal = ({ onClose }) => {
  return (
    <div>
      <div className="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-[1px] transition-opacity duration-300"
  >
    <div
